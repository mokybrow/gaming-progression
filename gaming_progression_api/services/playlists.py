...
from gaming_progression_api.models.playlists import AddPlaylist, GetPlaylists
...
class PlaylistsService:
    async def create_new_playlist(self, uow: IUnitOfWork, playlist_data: AddPlaylist, user_id: UUID4):
        async with uow:
            ...
            if get_playlist:
                return f'Youre already heave playlist with this name'
    ...
    async def add_playlist(self, uow: IUnitOfWork, playlist_id: UUID4, user_id: UUID4):
        async with uow:
            ...
            if get_playlist:
                ...
                return f'List was deletet from yours collection'
